export const PERMISSIONS = {
  ...
  // Invoices & Payments (Organization Admin Billing)
  ...
  // Super Admin Platform SaaS Billing
  PLATFORM_BILLING_VIEW: "platform_billing.view",
  PLATFORM_BILLING_MANAGE: "platform_billing.manage",
  ...
  switch (role) {
    ...
    case "MANAGER":
      return [
        ...
        PERMISSIONS.INVOICES_CREATE, PERMISSIONS.INVOICES_READ, PERMISSIONS.INVOICES_UPDATE, PERMISSIONS.INVOICES_DELETE, PERMISSIONS.INVOICES_SEND, PERMISSIONS.INVOICES_PAYMENT,
    ...
    case "SALES":
      return [
        ...
        PERMISSIONS.INVOICES_CREATE, PERMISSIONS.INVOICES_READ, PERMISSIONS.INVOICES_UPDATE, PERMISSIONS.INVOICES_SEND, PERMISSIONS.INVOICES_PAYMENT,
        "leads.view",
      ];
    case "SUPPORT":
      return [
