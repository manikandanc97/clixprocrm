  ...
  return (
    <CRMPageContainer>
      <div className="flex flex-col gap-6 w-full pb-6">
        ...
        {/* Current Workspace Plan Hero Bar */}
        <div className="rounded-xl border border-border/80 bg-card p-4 sm:p-5 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 items-stretch w-full">
          {displayPlans.map((planItem) => {
            ...
            return (
              <div
                key={planItem.id}
                className={`flex flex-col justify-between rounded-xl p-5 sm:p-6 transition-all relative ${
                  isGrowth
                    ? "bg-card border-2 border-primary ring-2 ring-primary/10 shadow-sm"
                    : "bg-card border border-border/80 hover:border-border shadow-xs"
                }`}
              >
                {/* Popular Badge */}
                {isGrowth && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-primary text-primary-foreground text-[10px] font-extrabold uppercase tracking-wider shadow-sm flex items-center gap-1">
                ...
                <div>
                  ...
                  {/* Price Section */}
                  <div className="my-4 pt-3.5 border-t border-border/60">
        ...
        {/* FULL 3-TIER COMPARISON TABLE */}
        <div className="rounded-xl border border-border/80 bg-card p-5 sm:p-6 shadow-xs w-full mt-4">
          <div
          ...
          >
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Explore in-depth specifications across CRM, automations, security, integrations, and limits.
              </p>
            </div>
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <div>
                      ...
                      <DialogDescription className="text-xs text-muted-foreground">
                        Select team seat count and review authoritative billing calculation before checkout.
                      </DialogDescription>
                    </div>
                  </div>
                </DialogHeader>
