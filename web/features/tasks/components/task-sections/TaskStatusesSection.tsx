                ...
                <div className="flex items-center gap-2.5 min-w-0 flex-1">
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-2 flex-1 max-w-md">
                      ...
                      <Button size="icon-xs" variant="default" onClick={onSaveRenameStatus} className="h-7 w-7">
                    ...
                    <div className="flex items-center gap-2 truncate">
                      ...
                      {st.isTerminal && (
                        <Badge variant="outline" className="text-[9.5px] py-0 px-1.5 border-emerald-500/30 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 shrink-0 font-medium">
                          Terminal
                        </Badge>
                      )}
                      {st.isSystem ? (
                        <Badge variant="outline" className="text-[9.5px] py-0 px-1.5 border-blue-500/30 bg-blue-500/10 text-blue-700 dark:text-blue-300 shrink-0 font-medium">
                          System Core
                        </Badge>
                      ) : (
                        <Badge variant="outline" className="text-[9.5px] py-0 px-1.5 border-purple-500/30 bg-purple-500/10 text-purple-700 dark:text-purple-300 shrink-0 font-medium">
                          Custom
                        </Badge>
                      )}
